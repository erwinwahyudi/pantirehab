...
<header>
  <div class="container">
    <div class="row">
      <div class="span9">
        <div class="logo">
          <img src="img/logo.png" height="145" width="65" style="float:left; left: 200px; top: 10px;">
          <h1>PANTI <span class="color">REHABILITASI NAPZA</span></h1>
          <div class="hmeta">Pemerintah Provinsi Kalimantan Barat</div>
               ...
               <div class="nav-collapse collapse">
                 <ul class="nav">
                  ...
                  <li><a href="?halaman=vppanti" >Profil Panti</a></li>
                   <li><a href="?halaman=galeri" style="background: #f3f3f3 !important;">Galeri</a></li>
...
<div class="content">
  ...
  <div class="row">
    <div class="span12">
        ...
        $query = mysql_query("SELECT * FROM galeri where kategori='galeri'");
        if(!$query) {
          die( mysql_error() );
        }
            ...
            while( $row = mysql_fetch_array($query))
            {
              ...
              $isi = $row['isi'];
              $gambar = $row['gambar'];
              echo "<div class=\"element one three\"><a href=\"$url_folder_gambar$gambar\" class=\"prettyPhoto[pp_gal]\">
                        <img src=\"$url_folder_gambar$gambar\" alt=\"\" />
                           <div class=\"pcap\">
                              <h4>$judul</h4>
                              <p>$isi</p>
                           </div>
