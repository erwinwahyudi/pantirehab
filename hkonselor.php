...
<div id="sidebar" class="collapse">
  ...
  <ul id="sidebar_menu" class="navbar nav nav-list sidebar_box">
    ...
    <a class="dashboard" href="hkonselor.php"><img src="img/menu_icons/dashboard.png">Beranda</a>
    </li>
    <li>
    <a class="widgets" href="?menu=ppkonselor">
    ...
    <img src="img/menu_icons/tables.png">Konseling</a>
    <ul id="collapse3" class="accordion-body collapse">
      <li><a href="?menu=kon_pilihpasien">Tambah Data Konseling</a></li>
      <li><a href="?menu=kon_viewkonseling">Lihat Laporan Konseling</a></li>
    </ul>
    </li>  
  </ul>
  <!-- End sidebar_box -->
...
<div id="main">
  <div class="container">
   ...
   <div class="top_right">
    ...
    <ul class="nav nav_menu">
      ...
      <span class="icon"><img src="img/menu_top/profile-avatar.png"></span><span class="title">Konselor</span></a>
      <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
        <li><a href="?menu=kon_ubahpass"><i class=" icon-cog"></i>Ubah Password</a></li>
  ...
  if(isset($_GET['menu'])){
		if($_GET['menu'] == "home"){
			include "hkonselor.php";
		}
		else if($_GET['menu'] == "ppkonselor"){
			include "ppkonselor.php";
		}
		else if($_GET['menu'] == "vpasien"){
			include "vpasien.php";
		}
		else if($_GET['menu'] == "konseling"){
			include "konseling.php";
		}
		else if($_GET['menu'] == "kon_pilihpasien"){
			include "kon_pilihpasien.php";
		}
		else if($_GET['menu'] == "kon_upprofil"){
			include "kon_upprofil.php";
		}
		else if($_GET['menu'] == "kon_viewkonseling"){
			include "kon_viewkonseling.php";
		}
		else if($_GET['menu'] == "kon_ubahpass"){
			include "kon_ubahpass.php";
		}
		else if($_GET['menu'] == "prokonseling"){
      		include "prokonseling.php";
    	}
...
<div class="container" style="margin:0 30px 0 30px; width:95%;">
 ...
 <div class="span7">
	<div class="box gradient">
		<div class="title">
            <h3><i class="icon-user"></i><span>PROFIL PRIBADI KONSELOR</span></h3>
		</div>
		<div class="content">
	  <?php
