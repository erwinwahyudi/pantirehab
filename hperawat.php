...
<div id="sidebar" class="collapse">
  ...
  <ul id="sidebar_menu" class="navbar nav nav-list sidebar_box">
    ...
    <a class="dashboard" href="hperawat.php"><img src="img/menu_icons/dashboard.png">Beranda</a>
    </li>
    <li>
    <a class="widgets" href="?menu=ppperawat">
    <img src="img/menu_top/profile-avatar.png">Profil Pribadi</a>
    </li>
    <li>
    <a class="widgets"data-parent="#sidebar_menu" href="?menu=vpasien">
    <img src="img/menu_icons/forms.png">Data Pasien</a>
    </li>
 
    <li class="accordion-group">
    <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse3">
    <img src="img/menu_icons/tables.png">Formulir Asesmen</a>
    <ul id="collapse3" class="accordion-body collapse">
      <li><a href="?menu=per_pilihpasienfa">Tambah Formulir Asesmen</a></li>
      <li><a href="?menu=per_pilihpasiende">Lihat Formulir Asesmen</a></li>
    </ul>
    </li>  
    <li class="accordion-group">
    <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse4">
    <img src="img/menu_icons/tables.png">Keperawatan</a>
    <ul id="collapse4" class="accordion-body collapse">
      <li><a href="?menu=per_pilihpasien">Tambah Data Keperawatan</a></li>
      <li><a href="?menu=per_viewkeperawatan">Lihat Laporan Keperawatan</a></li>
    </ul>
    </li>
    <li class="accordion-group">
    <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse5">
    <img src="img/menu_icons/tables.png">Perkembangan</a>
    <ul id="collapse5" class="accordion-body collapse">
      <li><a href="?menu=per_pilihpasienper">Tambah Data Perkembangan</a></li>
      <li><a href="?menu=per_viewperkembangan">Lihat Laporan Perkembangan</a></li>
    </ul>
    </li>
    <li class="accordion-group">
    <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse1">
    <img src="img/menu_icons/tables.png">Kode Pekerjaan</a>
    <ul id="collapse1" class="accordion-body collapse">
      <li><a href="?menu=kp">Tambah Kode Pekerjaan</a></li>
      <li><a href="?menu=vkp">Lihat Kode Pekerjaan</a></li>
    </ul>
    </li>
    <li class="accordion-group">
    <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse2">
    <img src="img/menu_icons/tables.png">Cara Penggunaan</a>
    <ul id="collapse2" class="accordion-body collapse">
      <li><a href="?menu=kcp">Tambah Cara Penggunaan</a></li>
      <li><a href="?menu=vkcp">Lihat Cara Penggunaan</a></li>
    </ul>
    </li>
  </ul>
  <!-- End sidebar_box -->
...
<div id="main">
  <div class="container">
   ...
   <div class="top_right">
    ...
    <ul class="nav nav_menu">
      ...
      <span class="icon"><img src="img/menu_top/profile-avatar.png"></span><span class="title">Perawat</span></a>
      <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
        <li><a href="?menu=per_ubahpass"><i class=" icon-cog"></i>Ubah Password</a></li>
  ...
  if(isset($_GET['menu'])){
        if($_GET['menu'] == "hperawat"){
            include "hperawat.php";
        }
        else if($_GET['menu'] == "ppperawat"){
            include "ppperawat.php";
        }
        else if($_GET['menu'] == "vpasien"){
            include "vpasien.php";
        }
        else if($_GET['menu'] == "forasesmen"){
            include "forasesmen.php";
        }
        else if($_GET['menu'] == "idemografis"){
            include "idemografis.php";
        }
        else if($_GET['menu'] == "smedis"){
            include "smedis.php";
        } 
        else if($_GET['menu'] == "spekerjaan"){
            include "spekerjaan.php";
        } 
        else if($_GET['menu'] == "spnarkotika"){
            include "spnarkotika.php";
        }
        else if($_GET['menu'] == "slegal"){
            include "slegal.php";
        }
        else if($_GET['menu'] == "rksosial"){
            include "rksosial.php";
        }
        else if($_GET['menu'] == "spsikiatris"){
            include "spsikiatris.php";
        }
		else if($_GET['menu'] == "pfisik"){
            include "pfisik.php";
		}
        else if($_GET['menu'] == "keperawatan"){
            include "keperawatan.php";
        }
        else if($_GET['menu'] == "perkembangan"){
            include "perkembangan.php";
		}
		else if($_GET['menu'] == "per_upprofil"){
			include "per_upprofil.php";
		}
		else if($_GET['menu'] == "per_viewkeperawatan"){
			include "per_viewkeperawatan.php";
        }
		else if($_GET['menu'] == "per_viewperkembangan"){
			include "per_viewperkembangan.php";
        }
        else if($_GET['menu'] == "per_pilihpasien"){
            include "per_pilihpasien.php";
        }
         else if($_GET['menu'] == "per_pilihpasienper"){
            include "per_pilihpasienper.php";
        }
        else if($_GET['menu'] == "per_pilihpasienfa"){
            include "per_pilihpasienfa.php";
        }
		else if($_GET['menu'] == "per_pilihpasiende"){
            include "per_pilihpasiende.php";
        }
		else if($_GET['menu'] == "kp"){
            include "kp.php";
        }
		else if($_GET['menu'] == "kcp"){
            include "kcp.php";
        }
		else if($_GET['menu'] == "vkp"){
			include "vkp.php";
        }
		else if($_GET['menu'] == "vkcp"){
			include "vkcp.php";
        }
		else if($_GET['menu'] == "per_ubahpass"){
			include "per_ubahpass.php";
		}
        else if($_GET['menu'] == "per_viewidemografis"){
            include "per_viewidemografis.php";
        }
		else if($_GET['menu'] == "per_viewsmedis"){
            include "per_viewsmedis.php";
        }
		else if($_GET['menu'] == "per_viewspekerjaan"){
            include "per_viewspekerjaan.php";
        }
		else if($_GET['menu'] == "per_viewspnarkotika"){
            include "per_viewspnarkotika.php";
        }
		else if($_GET['menu'] == "per_viewslegal"){
            include "per_viewslegal.php";
        }
		else if($_GET['menu'] == "per_viewrksosial"){
            include "per_viewrksosial.php";
        }
		else if($_GET['menu'] == "per_viewspsikiatris"){
            include "per_viewspsikiatris.php";
        }
		else if($_GET['menu'] == "per_viewpfisik"){
            include "per_viewpfisik.php";
        }
		else if($_GET['menu'] == "proidemografis"){
      		include "proidemografis.php";
    	}
		else if($_GET['menu'] == "prokeperawatan"){
      		include "prokeperawatan.php";
    	}
		else if($_GET['menu'] == "properkembangan"){
      		include "properkembangan.php";
    	}
		else if($_GET['menu'] == "prokp"){
      		include "prokp.php";
    	}
		else if($_GET['menu'] == "prokcp"){
      		include "prokcp.php";
    	}
...
<div class="span7">
	<div class="box gradient">
		<div class="title">
            <h3><i class="icon-user"></i><span>PROFIL PRIBADI PERAWAT</span></h3>
		</div>
		<div class="content">
	 ...
	 ?>
     	<form class="form-horizontal row-fluid">
                ...
                <div class="controls span4">
                <input type="text" id="disabled-input" class="row-fluid" disabled="disabled" value="<?php echo $row['nohp_perawat']; ?>">
                </div>
              	</div>
