...
<div id="sidebar" class="collapse">
  ...
  <ul id="sidebar_menu" class="navbar nav nav-list sidebar_box">
    ...
    <a class="dashboard" href="hlogistik.php"><img src="img/menu_icons/dashboard.png">Beranda</a>
    </li>
    <li>
    <a class="widgets" href="?menu=pplogistik">
    ...
    <img src="img/menu_icons/tables.png">Kebutuhan Pasien</a>
    <ul id="collapse3" class="accordion-body collapse">
      <li><a href="?menu=kpasien">Tambah Kebutuhan Pasien</a></li>
      <li><a href="?menu=log_viewkpasien">Lihat Kebutuhan Pasien</a></li>
    </ul>
    </li>  
  </ul>
 <!-- End sidebar_box -->
...
<div id="main">
  <div class="container">
   ...
   <div class="top_right">
    ...
    <ul class="nav nav_menu">
      ...
      <span class="icon"><img src="img/menu_top/profile-avatar.png"></span><span class="title">Logistik</span></a>
      <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
        <li><a href="?menu=log_ubahpass"><i class=" icon-cog"></i>Ubah Password</a></li>
  ...
  if(isset($_GET['menu'])){
		if($_GET['menu'] == "home"){
		include "hlogistik.php";
		}
		else if($_GET['menu'] == "pplogistik"){
			include "pplogistik.php";
		}
		else if($_GET['menu'] == "kpasien"){
			include "kpasien.php";
		}
		else if($_GET['menu'] == "log_upprofil"){
			include "log_upprofil.php";
		}
		else if($_GET['menu'] == "log_viewkpasien"){
			include "log_viewkpasien.php";
		}
		else if($_GET['menu'] == "log_ubahpass"){
			include "log_ubahpass.php";
		}
		else if($_GET['menu'] == "prokpasien"){
      		include "prokpasien.php";
    	}
...
<div class="container" style="margin:0 30px 0 30px; width:95%;">
 ...
 <div class="span7">
	<div class="box gradient">
		<div class="title">
            <h3><i class="icon-user"></i><span>PROFIL PRIBADI LOGISTIK</span></h3>
		</div>
		<div class="content">
	  <?php
