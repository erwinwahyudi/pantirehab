...
<div id="sidebar" class="collapse">
  ...
  <ul id="sidebar_menu" class="navbar nav nav-list sidebar_box">
    ...
    <a class="dashboard" href="hkaryawan.php"><img src="img/menu_icons/dashboard.png">Beranda</a>
    </li>
    <li>
    <a class="widgets" href="?menu=ppkaryawan">
    ...
    <img src="img/menu_icons/tables.png">Administrasi</a>
    <ul id="collapse3" class="accordion-body collapse">
      <li><a href="?menu=kar_pilihpasien">Tambah Data Administrasi</a></li>
      <li><a href="?menu=kar_viewadministrasi">Lihat Laporan Administrasi</a></li>
    </ul>
    </li>  
  </ul>
  <!-- End sidebar_box -->
...
<div id="main">
  <div class="container">
   ...
   <div class="top_right">
    ...
    <ul class="nav nav_menu">
      ...
      <span class="icon"><img src="img/menu_top/profile-avatar.png"></span><span class="title">Karyawan</span></a>
      <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
        <li><a href="?menu=kar_ubahpass"><i class=" icon-cog"></i>Ubah Password</a></li>
  ...
  if(isset($_GET['menu'])){
		if($_GET['menu'] == "home"){
			include "hkaryawan.php";
		}
		else if($_GET['menu'] == "ppkaryawan"){
			include "ppkaryawan.php";
		}
		else if($_GET['menu'] == "administrasi"){
			include "administrasi.php";
		}
		else if($_GET['menu'] == "kar_pilihpasien"){
			include "kar_pilihpasien.php";
		}
		else if($_GET['menu'] == "kar_upprofil"){
			include "kar_upprofil.php";
		}
		else if($_GET['menu'] == "kar_viewadministrasi"){
			include "kar_viewadministrasi.php";
		}
		else if($_GET['menu'] == "kar_ubahpass"){
			include "kar_ubahpass.php";
		}
		else if($_GET['menu'] == "proadministrasi"){
      		include "proadministrasi.php";
    	}
...
<div class="container" style="margin:0 30px 0 30px; width:95%;">
 ...
 <div class="span7">
	<div class="box gradient">
		<div class="title">
            <h3><i class="icon-user"></i><span>PROFIL PRIBADI KARYAWAN</span></h3>
		</div>
		<div class="content">  
      <?php
